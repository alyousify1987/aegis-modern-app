...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    menu_objectives: 'Objectives & KPI',
    menu_external_auditor: 'External Auditor',
    menu_management_review: 'Management Review',
    menu_internal_auditor: 'Internal Auditor',
  ...
  fr: {
    ...
    menu_diagnostics: 'Diagnostics',
    menu_objectives: 'Objectifs & KPI',
    menu_external_auditor: 'Auditeur Externe',
    menu_management_review: 'Revue de Direction',
    menu_internal_auditor: 'Auditeur Interne',
  ...
  ar: {
    ...
    menu_documents: 'مركز الوثائق',
    menu_ncrs: 'مركز عدم المطابقة',
    ...
    menu_objectives: 'الأهداف ومؤشرات الأداء',
    menu_external_auditor: 'المدقق الخارجي',
    menu_management_review: 'مراجعة الإدارة',
    menu_internal_auditor: 'المدقق الداخلي',
